...
/**
 *\fn void PQCLEAN_HQC1281CCA2_LEAKTIME_hqc_secret_key_to_string(unsigned char* sk, const unsigned char* sk_seed, const unsigned char* pk)
...
/**
 *\fn void PQCLEAN_HQC1281CCA2_LEAKTIME_hqc_secret_key_from_string(uint8_t* x, uint8_t* y, unsigned char* pk, const unsigned char* sk)
...
/**
 *\fn void PQCLEAN_HQC1281CCA2_LEAKTIME_hqc_public_key_to_string(unsigned char* pk, const unsigned char* pk_seed, uint8_t* s)
...
/**
 *\fn void PQCLEAN_HQC1281CCA2_LEAKTIME_hqc_public_key_from_string(uint8_t* h, uint8_t* s, const unsigned char* pk)
...
/**
 *\fn void PQCLEAN_HQC1281CCA2_LEAKTIME_hqc_ciphertext_from_string(uint8_t* u, uint8_t* v, unsigned char* d, const unsigned char* ct)
