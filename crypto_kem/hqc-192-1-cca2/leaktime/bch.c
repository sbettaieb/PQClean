...
/**
 * \fn void PQCLEAN_HQC1921CCA2_LEAKTIME_bch_code_encode(uint8_t* em, uint8_t* m)
 ...
 */
void PQCLEAN_HQC1921CCA2_LEAKTIME_bch_code_encode(uint8_t *em, const uint8_t *m) {
...
static void get_generator_poly(uint8_t *g) {
    ...
    uint8_t tmp[(PARAM_G / 8) + 1] = { 0xC2, 0x6D, 0x64, 0xFC, 0xDE, 0xF4,
                                       0x4E, 0xD7, 0x52, 0x1E, 0xF8, 0x49, 0xC6, 0x51, 0x08, 0xB0, 0xCD, 0x57,
                                       0xA6, 0xB3, 0x7D, 0x74, 0x6F, 0x78, 0x40, 0x83, 0xCD, 0x09, 0x29, 0xAF,
                                       0xB5, 0xF8, 0xBF, 0x56, 0x33, 0x7F, 0x1E, 0x89, 0xB2, 0xD5, 0x83, 0xFF,
                                       0x6B, 0xFB, 0x62, 0x7D, 0x42, 0xF4, 0x12, 0xF8, 0x1F, 0x49, 0xA0, 0x18,
                                       0xE6, 0x34, 0x8A, 0x8F, 0x89, 0xB2, 0xDC, 0x37, 0x42, 0x26
                                     };
...
/**
 * \fn void PQCLEAN_HQC1921CCA2_LEAKTIME_bch_code_decode(uint8_t* m, const uint8_t* em)
 ...
 */
void PQCLEAN_HQC1921CCA2_LEAKTIME_bch_code_decode(uint8_t *m, const uint8_t *em) {
    gf_tables tables;
    ...
    PQCLEAN_HQC1921CCA2_LEAKTIME_vect_add(tmp, e, em, VEC_N1_SIZE_BYTES);
