...
/**
 *\fn int PQCLEAN_HQC1921CCA2_LEAKTIME_crypto_kem_keypair(uint8_t* pk, uint8_t* sk)
...
/**
 *\fn int PQCLEAN_HQC1921CCA2_LEAKTIME_crypto_kem_enc(uint8_t* ct, uint8_t* ss, const uint8_t* pk)
...
/**
 *\fn int PQCLEAN_HQC1921CCA2_LEAKTIME_crypto_kem_dec(uint8_t* ss, const uint8_t* ct, const uint8_t* sk)
...
int PQCLEAN_HQC1921CCA2_LEAKTIME_crypto_kem_dec(uint8_t *ss, const uint8_t *ct, const uint8_t *sk) {
    ...
    if (PQCLEAN_HQC1921CCA2_LEAKTIME_vect_compare(v, v2, VEC_N1N2_SIZE_BYTES) != 0) {
        abort = 1;
    }
