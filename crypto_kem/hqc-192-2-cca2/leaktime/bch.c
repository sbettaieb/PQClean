...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_bch_code_encode(uint8_t* em, uint8_t* m)
 ...
 */
void PQCLEAN_HQC1922CCA2_LEAKTIME_bch_code_encode(uint8_t *em, const uint8_t *m) {
...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_bch_code_decode(uint8_t* m, const uint8_t* em)
 ...
 */
void PQCLEAN_HQC1922CCA2_LEAKTIME_bch_code_decode(uint8_t *m, const uint8_t *em) {
    gf_tables tables;
    ...
    PQCLEAN_HQC1922CCA2_LEAKTIME_vect_add(tmp, e, em, VEC_N1_SIZE_BYTES);
