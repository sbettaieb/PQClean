...
// so that (note: N_WORDS = 731)
//   T(731) <= 4174,
// although in reality T(731) = 4098, which could be hardcoded since N_WORDS is fixed.
//
// Wee need space K(9) + T(731):
#define GF2X_WORKSPACE_WORDS (44 + 4098)
