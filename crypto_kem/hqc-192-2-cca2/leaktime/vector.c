...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_vect_fixed_weight(AES_XOF_struct* ctx, uint8_t *v, uint16_t weight)
 ...
 */
void PQCLEAN_HQC1922CCA2_LEAKTIME_vect_fixed_weight(AES_XOF_struct *ctx, uint8_t *v, uint16_t weight) {
...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_vect_set_random(AES_XOF_struct* ctx, uint8_t* v)
...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_vect_set_random_from_randombytes(uint8_t* v)
...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_vect_add(uint8_t* o, const uint8_t* v1, const uint8_t* v2, uint32_t size)
...
/**
 * \fn int PQCLEAN_HQC1922CCA2_LEAKTIME_vect_compare(const uint8_t* v1, const uint8_t* v2, uint32_t size)
...
/**
 * \fn void PQCLEAN_HQC1922CCA2_LEAKTIME_vect_resize(uint8_t* o, uint32_t size_o, const uint8_t* v, uint32_t size_v)
