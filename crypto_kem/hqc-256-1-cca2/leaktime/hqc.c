...
/**
 *\fn void PQCLEAN_HQC2561CCA2_LEAKTIME_hqc_pke_keygen(uint8_t* pk, uint8_t* sk)
...
void PQCLEAN_HQC2561CCA2_LEAKTIME_hqc_pke_keygen(uint8_t *pk, uint8_t *sk) {
    ...
    PQCLEAN_HQC2561CCA2_LEAKTIME_ntl_cyclic_product(s, h, y);
    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_add(s, s, x, VEC_N_SIZE_BYTES);
...
void PQCLEAN_HQC2561CCA2_LEAKTIME_hqc_pke_encrypt(uint8_t *u, uint8_t *v, const uint8_t *m, const uint8_t *theta, const uint8_t *pk) {
    ...
    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_fixed_weight(&seedexpander, r1, PARAM_OMEGA_R);
    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_fixed_weight(&seedexpander, r2, PARAM_OMEGA_R);
    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_fixed_weight(&seedexpander, e, PARAM_OMEGA_E);

    // Compute u = r1 + r2.h
    PQCLEAN_HQC2561CCA2_LEAKTIME_ntl_cyclic_product(u, r2, h);
    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_add(u, u, r1, VEC_N_SIZE_BYTES);
    ...
    PQCLEAN_HQC2561CCA2_LEAKTIME_ntl_cyclic_product(tmp2, r2, s);

    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_add(tmp2, tmp2, e, VEC_N_SIZE_BYTES);
...
void PQCLEAN_HQC2561CCA2_LEAKTIME_hqc_pke_decrypt(uint8_t *m, const uint8_t *u, const uint8_t *v, const uint8_t *sk) {
    ...
    PQCLEAN_HQC2561CCA2_LEAKTIME_ntl_cyclic_product(tmp2, y, u);
    PQCLEAN_HQC2561CCA2_LEAKTIME_vect_add(tmp2, tmp1, tmp2, VEC_N_SIZE_BYTES);
