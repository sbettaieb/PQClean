...
// so that (note: N_WORDS = 994)
//   T(994) <= 5626,
// although in reality T(994) = 5572, which could be hardcoded since N_WORDS is fixed.
// We need space K(9) + T(994):
#define GF2X_WORKSPACE_WORDS (44 + 5572)
