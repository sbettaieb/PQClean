 ...
 */
void PQCLEAN_HQC2562CCA2_AVX2_LEAKTIME_fft_t(uint16_t *f, const uint16_t *w, size_t f_coeffs) {
 ...
 */
void PQCLEAN_HQC2562CCA2_AVX2_LEAKTIME_fft(uint16_t *w, const uint16_t *f, size_t f_coeffs) {
    uint16_t betas[PARAM_M - 1];
    uint16_t betas_sums[1 << (PARAM_M - 1)];
