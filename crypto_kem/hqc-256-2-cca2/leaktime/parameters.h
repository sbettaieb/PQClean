...
// so that (note: N_WORDS = 1058)
//   T(1058) <= 5978,
// although in reality T(1058) = 5924, which could be hardcoded since N_WORDS is fixed.
// We need space K(9) + T(5924):
#define GF2X_WORKSPACE_WORDS (44 + 5924)
