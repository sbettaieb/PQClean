...
/**
 * \fn void PQCLEAN_HQC2562CCA2_LEAKTIME_tensor_code_encode(uint8_t* em, uint8_t* m)
...
/**
 * \fn void PQCLEAN_HQC2562CCA2_LEAKTIME_tensor_code_decode(uint8_t* m, uint8_t* em)
