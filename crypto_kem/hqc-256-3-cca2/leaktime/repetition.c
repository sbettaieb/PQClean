...
/**
 * \fn void PQCLEAN_HQC2563CCA2_LEAKTIME_repetition_code_encode(uint8_t* em, uint8_t* m)
...
/**
 * \fn void PQCLEAN_HQC2563CCA2_LEAKTIME_repetition_code_decode(uint8_t* m, const uint8_t* em)
