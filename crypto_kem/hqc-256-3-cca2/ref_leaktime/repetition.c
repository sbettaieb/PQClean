 ...
 */
void PQCLEAN_HQC2563CCA2_REF_LEAKTIME_repetition_code_encode(uint8_t *em, const uint8_t *m) {
 ...
 */
void PQCLEAN_HQC2563CCA2_REF_LEAKTIME_repetition_code_decode(uint8_t *m, const uint8_t *em) {
  size_t t = 0; // m index
